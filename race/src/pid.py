class PidCal:
	...
	self.error_sum = 0
    	self.error_old = 0
    	self.p = [0.004, 0.00005, 0.005] # optimized kp,ki,kd original
    	#self.p = [0.8, 0.005, 0.00005]
    	self.dp = [self.p[0]/10, self.p[1]/10, self.p[2]/10] # to twiddle kp, ki, kd
    def cal_error(self, setpoint=310):
        return setpoint - self.x

    # twiddle is for optimize the kp,ki,kd
    def twiddle(self, setpoint=310):
    ...
    def pid_control(self, x_current, setpoint=310):
